...
module.exports = NodeHelper.create({
	...
	getData: function(payload) {
		...
		this.instance = "MMM-CTA-DATA2" + payload.modInstance;
		...
		if (payload.urlBus !== null && payload.key !== null && payload.stpid !== null && payload.maxRes !== null) {
			...
			busReady = true;
		} else { console.log("MMM-CTA2: Bus config incomplete!!!"); };
		...
		if (payload.urlTrain !== null && payload.keyTrain !== null && payload.maxResTrain !== null && payload.idTrain !== null) {
			...
			trainReady = true;
		} else { console.log("MMM-CTA2: Train config incomplete!!!"); };
			...
			if (!error && response.statusCode == 200) {
				...
				request({url: myUrlTrain}, function (error, response, body) {
					...
					if (!error && response.statusCode == 200) {
						...
						self.sendSocketNotification('MMM-CTA-DATA2', bodyJs)
					}
				});
			} else {
