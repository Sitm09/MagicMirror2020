...
*/
	...
	start: function() {
		...
		if (this.updateTime < 50000) {
			this.updateTime = 50000 // Every 15 sec (overkill as they don't update API that often);
		};
		this.loaded = false;
	...
	getDom: function() {
    	...
    	scheduleUpdate: function() {
        	...
        	this.updateTimer = setInterval(function() {
						try {                                 // This elimates the error I
								self.apiRequest(self);           //  kept receiving in console - MTS
						} catch (e) {
						}
